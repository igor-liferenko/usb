...
while (!(UEINTX & (1 << TXINI))) ; /* CAVEAT: wait until the ACK packet generated by
  previous command is sent to host, to ensure that previous address is used, or the ACK
  packet will not be delivered */
UDADDR |= 1 << ADDEN;
